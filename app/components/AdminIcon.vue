...
// Single-source line icons for the admin UI.
...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'opportunities'">
    ...
    <template v-else-if="name === 'categorias'">
      <path d="M3 7V5a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v1" />
      <path d="M3 7h18a0 0 0 0 1 0 0v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z" />
    </template>
    <template v-else-if="name === 'tags'">
      <path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z" />
      <line x1="7" y1="7" x2="7.01" y2="7" />
    </template>
    <template v-else-if="name === 'taxas'">
    ...
    <template v-else-if="name === 'followup'">
